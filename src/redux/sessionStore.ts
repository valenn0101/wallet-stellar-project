...
import { CUSTOM_TOAST_STYLE, DELAY_FOR_INACTIVITY_RESET, TOAST_ALERT_MESSAGE } from "../utils/constants";
...
setupInactivityReset(sessionStore, DELAY_FOR_INACTIVITY_RESET);
